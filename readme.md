...
See **[TODO.md](TODO.md)**. Each folder has bilingual docs: `readme.md` (English) + `readme.zh.md` (Chinese). Includes Safari, Emacs, JetBrains plugins, browser extensions, consoles, handhelds, etc.
...
# … every folder has readme.md + readme.zh.md
```
