# asm_x86app1 — x86 (IA-32) assembly teaching Sokoban
...
NASM cdecl; `nasm -f elf32` or `win32`

## This directory

| File | Description |
|------|-------------|
| `try_move_x86.asm` | **full** `sk_try_move` (layout matches game.h) |
...
```bash
# assemble try_move_x86.asm -> try_move.o, then:
