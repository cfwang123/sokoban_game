# asm_loongarchapp1 — LoongArch assembly teaching Sokoban
...
LoongArch64; loongarch64-linux-gnu-gcc -c

## This directory

| File | Description |
|------|-------------|
| `try_move_loongarch.S` | **full** `sk_try_move` (layout matches game.h) |
...
```bash
# assemble try_move_loongarch.S -> try_move.o, then:
