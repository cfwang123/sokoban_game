# asm_x64app1 — x86-64 (AMD64) assembly teaching Sokoban
...
Win64 MinGW / System V (cpp); `make asm` on this host

## This directory

| File | Description |
|------|-------------|
| `try_move_x64.S` | **full** `sk_try_move` (layout matches game.h) |
...
```bash
# assemble try_move_x64.S -> try_move.o, then:
