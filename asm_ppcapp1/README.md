# asm_ppcapp1 — PowerPC assembly teaching Sokoban
...
32-bit SysV-ish; powerpc-linux-gnu-gcc -c

## This directory

| File | Description |
|------|-------------|
| `try_move_ppc.S` | **full** `sk_try_move` (layout matches game.h) |
...
```bash
# assemble try_move_ppc.S -> try_move.o, then:
