# asm_thumbapp1 — ARM Thumb / Thumb-2 assembly teaching Sokoban
...
unified Thumb-2; arm-none-eabi-gcc -mthumb -c

## This directory

| File | Description |
|------|-------------|
| `try_move_thumb.S` | **full** `sk_try_move` (layout matches game.h) |
...
```bash
# assemble try_move_thumb.S -> try_move.o, then:
