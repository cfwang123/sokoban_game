# asm_6502app1 — 6502 / 65C02 assembly teaching Sokoban
...
ca65; A=dx X=dy, .importzp game_ptr

## This directory

| File | Description |
|------|-------------|
| `try_move_6502.s` | **full** `sk_try_move` (layout matches game.h) |
...
```bash
# assemble try_move_6502.s -> try_move.o, then:
