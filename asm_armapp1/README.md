# asm_armapp1 — ARM32 (AArch32 ARM) assembly teaching Sokoban
...
AAPCS; arm-linux-gnueabi-gcc -c

## This directory

| File | Description |
|------|-------------|
| `try_move_arm.S` | **full** `sk_try_move` (layout matches game.h) |
...
```bash
# assemble try_move_arm.S -> try_move.o, then:
